...
**
** Created: Tue Jul 22 18:35:39 2014
...
static const char qt_meta_stringdata_q_user[] = {
    "q_user\0\0text,master_list,htags\0"
    "new_tweet(std::string,std::map<std::string,q_user*>&,std::map<std::str"
    "ing,std::vector<Tweet*> >&)\0"
...
void q_user::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->new_tweet((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< std::map<std::string,q_user*>(*)>(_a[2])),(*reinterpret_cast< std::map<std::string,std::vector<Tweet*> >(*)>(_a[3]))); break;
